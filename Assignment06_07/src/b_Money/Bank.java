...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			//here changed for accountlist.put(params) from accountlist.get(params)
			//because the account was not opened
		}
	}
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) { //added not to the condition as it threw the exception when the account existed
	 ...
	 */
	public void tick(){ //removed throws exception as it does not throw anythind
